...
import com.realestate.realestatemanagement.model.Role;
import com.realestate.realestatemanagement.model.User;
import com.realestate.realestatemanagement.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public User save(UserRegisterationDto dto) {
        User user = new User(
                ...
                Arrays.asList(new Role("operator"))
                );
